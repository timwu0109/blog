...
@section('main')
    <div class="text-center">
        ...
        <div class='flex justify-center mt-4'>
            ...
            <a href="{{ route('blog.index') }}" class='mr-2 px-2 py-1  bg-cyan-800 rounded text-zinc-100'>回首頁</a>
            <a href="{{ route('logout')}}" class="px-2 py-1 bg-red-600 text-zinc-100 rounded">登出</a>
